    ...
    private void showNotification() {
        try {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.vlc_ic_stat_vlc)
            ...
            if (Util.isJellyBeanOrLater()) {
                ...
                RemoteViews view = new RemoteViews(getPackageName(), R.layout.vlc_notification);
                if (cover != null)
                    view.setImageViewBitmap(R.id.cover, cover);
                view.setTextViewText(R.id.songName, title);
                view.setTextViewText(R.id.artist, artist);
                view.setImageViewResource(R.id.play_pause, mLibVLC.isPlaying() ? R.drawable.vlc_ic_pause : R.drawable.vlc_ic_play);
                ...
                RemoteViews view_expanded = new RemoteViews(getPackageName(), R.layout.vlc_notification_expanded);
                if (cover != null)
                ...
                view_expanded.setImageViewResource(R.id.play_pause, mLibVLC.isPlaying() ? R.drawable.vlc_ic_pause : R.drawable.vlc_ic_play);
