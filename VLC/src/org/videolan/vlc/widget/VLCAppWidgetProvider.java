...
public class VLCAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.vlc_widget);
        ...
        if (ACTION_WIDGET_UPDATE.equals(action)) {
            ...
            views.setImageViewResource(R.id.play_pause, isplaying ? R.drawable.vlc_ic_pause : R.drawable.vlc_ic_play);
            ...
            if (cover != null)
                ...
                views.setImageViewResource(R.id.cover, R.drawable.vlc_cone);
