...
public class ExpandableLayout extends LinearLayout {
    ...
    public ExpandableLayout(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.vlc_expandable_layout, this, true);
    ...
    private void setState(Boolean expanded) {
        mExpanded = expanded;
        mMore.setImageResource(expanded ? R.drawable.vlc_ic_up : R.drawable.vlc_ic_down);
