...
public class AudioMiniPlayer extends Fragment implements IAudioPlayer {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.vlc_audio_player_mini, container, false);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        inflater.inflate(R.menu.vlc_audio_player_mini, menu);
    ...
    public void show() {
        FragmentTransaction ft = getActivity().getSupportFragmentManager()
                .beginTransaction();
        ft.setCustomAnimations(R.anim.vlc_anim_enter_bottom, 0);
        ft.show(this);
        ft.commit();
    }
    ...
    public void hide() {
        ...
        */
        ft.setCustomAnimations(0, R.anim.vlc_anim_leave_bottom);
        ft.hide(this);
        ft.commit();
    }
