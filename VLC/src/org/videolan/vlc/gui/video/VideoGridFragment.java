...
public class VideoGridFragment extends SherlockGridFragment implements ISortable {
    ...
    {
        View v = inflater.inflate(R.layout.vlc_video_grid, container, false);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        inflater.inflate(R.menu.vlc_video_list, menu);
    }
    ...
    public void onContextPopupMenu(View anchor, final int position) {
        ...
        popupMenu.getMenuInflater().inflate(R.menu.vlc_video_list, popupMenu.getMenu());
