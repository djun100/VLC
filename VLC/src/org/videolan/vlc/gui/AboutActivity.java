...
public class AboutActivity extends FragmentActivity implements OnTabChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vlc_about);
        displayVersionName();
    ...
    public void onTabChanged(String newTag) {
        ...
        if(oldTag == "main" && newTag == "licence") {
            ft.setCustomAnimations(R.anim.vlc_anim_enter_right, R.anim.vlc_anim_leave_left);
        } else if(newTag == "main" && oldTag == "licence") {
            ft.setCustomAnimations(R.anim.vlc_anim_enter_left, R.anim.vlc_anim_leave_right);
        }
