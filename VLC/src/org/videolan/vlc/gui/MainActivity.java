...
public class MainActivity extends SherlockFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vlc_sliding_menu);
        ...
        View sidebar = LayoutInflater.from(this).inflate(R.layout.vlc_sidebar, null);
    ...
    public static void ShowFragment(FragmentActivity activity, String tag, Fragment fragment) {
        ...
        ft.setCustomAnimations(R.anim.vlc_anim_enter_right, R.anim.vlc_anim_leave_left, R.anim.vlc_anim_enter_left, R.anim.vlc_anim_leave_right);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.vlc_media_library, menu);
    ...
    private void showInfoDialog() {
        ...
        infoDialog.setContentView(R.layout.vlc_info_dialog);
